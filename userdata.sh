...
REGION="us-west-2" # use one of us-east-1, us-west-1, eu-west-1
CHEF_SERVER_NAME="chef-server01" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="chef-server01-ih5kqwdvrdaoispe.us-west-2.opsworks-cm.io" # The FQDN of your Chef Server
